...
PerfTimingProbe.prototype.teardown = function(browser) {
	var code = function() {
        ...
        marks.forEach(function(val) {
			...
			window.__optlyPerfData = {
				perfTiming: result,
				perfCounters: window.__optlyPerfCounters
			};
		});
	};
	...
	return browser.execute(helpers.fnCall(code)).then(function() {
		...
		var perfData = browser.eval('window.__optlyPerfData');
		debug('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$');
		debug('[PERF DATA] optlyMatchSelectorCount: ' + perfData.perfCounters.optlyMatchSelectorCount);
    debug('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$');
		return perfData;
	}).then(function(res) {
		me.emit('data', res);
